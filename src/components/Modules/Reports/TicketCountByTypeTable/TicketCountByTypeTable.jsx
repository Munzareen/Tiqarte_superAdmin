...
import { useGetTicketTypeCountReporQuery } from "../../../../store/services/Reports/Report.services"

export const TicketCountByTypeTable = () => {
  const { data, isLoading, isError } = useGetTicketTypeCountReporQuery()
  // console.log(data)
